...
function Dashboard({ setLoggedIn }) {
  ...
  const isEditFormValid = () => { //Edit Form 
    ...
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-black text-white text-x rounded font-bold hover:bg-black transition">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-4 rounded shadow h-fit max-h-[80vh] overflow-y-auto">
          <h2 className="text-lg font-bold mb-3">All Jobs List</h2>
              ...
              {editJobId === job._id ? (
                ...
                <div className="flex justify-between items-start">
                  ...
                  <button onClick={() => startEdit(job)}
                      className="px-2 py-1 bg-blue-500 text-white text-xs font-bold rounded hover:bg-blue-300 transition">
                      Update
                  </button>

                  <button onClick={() => deleteJob(job._id)}
                      className="px-2 py-1 bg-red-500 text-white text-xs rounded font-bold hover:bg-red-300 transition">
                     Delete
                  </button>
        ...
        {/* Job Form */}
        <div className="bg-white p-4 rounded shadow max-w-md w-full ml-auto mr-20">
